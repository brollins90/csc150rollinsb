...
public class BattleBotTests {
	 ...
	 */
	public boolean checkFieldSize(Field bbField, int expectedColumnSize, int expectedRowSize) {
	 ...
	 */
	public boolean checkBotIsOnField(Field bbField) {
	 ...
	 */
	public boolean checkNoEmptySpots(Field bbField) {
		String fieldString = bbField.toString();
	...
	public void runTests() {
		...
		System.out.println(checkFieldSize(new Field(3, 3), 3, 3));

		System.out.print("Grid size set to 3x5 worked: ");
		System.out.println(checkFieldSize(new Field(3, 5), 3, 5));

		System.out.print("Grid size set to 5x3 worked: ");
		System.out.println(checkFieldSize(new Field(5, 3), 5, 3));

		System.out.print("Grid size set to 5x5 worked: ");
		System.out.println(checkFieldSize(new Field(5, 5), 5, 5));
		...
		testContainer = new Container(new BattleBot(0, 0, 1, 1));
		System.out.println(checkBotLocation(testContainer, 0, 0, 0));
		
		System.out.print("BattleBot starts in top right corner: ");
		testField = new Field(5, 5);
		testContainer = new Container(new BattleBot(testField.getNumberOfColumns() -1, 0, 1, 1));
		System.out.println(checkBotLocation(testContainer, 0, 4, 0));

		System.out.print("BattleBot starts in bottom left corner: ");
		testField = new Field(5, 5);
		testContainer = new Container(new BattleBot(0, testField.getNumberOfRows() - 1, 1, 1));
		System.out.println(checkBotLocation(testContainer, 0, 0, 4));

		System.out.print("BattleBot starts in bottom right corner: ");
		testField = new Field(5, 5);
		testContainer = new Container(new BattleBot(testField.getNumberOfColumns() -1, testField.getNumberOfRows() - 1, 1, 1));
		...
		testContainer = new Container(new BattleBot(0, 0, 2, 1));
		testContainer.moveBots(1);
		...
		testContainer = new Container(new BattleBot(0, 0, 1, 2));
		testContainer.moveBots(1);
		...
		testContainer = new Container(new BattleBot(0, 0));
		...
		testField = new Field(10, 10);
		testContainer.placeBotsOnField(testField);
		System.out.println(checkBotIsOnField(testField));
