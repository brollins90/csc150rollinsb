...
public class Field {
	 ...
	 */
	public Field(int numberOfColumns, int numberOfRows, int numberOfBots) {
		rand = new Random();
		field = new boolean[numberOfColumns][numberOfRows];

		bots = new Bot[numberOfBots];
		for (int i = 0; i < numberOfBots; i++) {
			bots[i] = new Bot(getRandomLocation(getNumberOfColumns()), getRandomLocation(getNumberOfRows()));
		}
	}
	 ...
	 */
	public void addBot() {
		Bot newBot = new Bot(getRandomLocation(getNumberOfColumns()), getRandomLocation(getNumberOfRows()));
		addBot(newBot);
	}
	...
	public void addBot(Bot newBot) {
		Bot[] newBots = new Bot[bots.length + 1];
	 ...
	 */
	public Bot getBot(int botIndex) {
