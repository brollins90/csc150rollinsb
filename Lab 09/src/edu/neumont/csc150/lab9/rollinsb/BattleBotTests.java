...
public class BattleBotTests {
	...
	public boolean checkBotIsOnField(Console bbField) {
		...
		if (fieldString.indexOf('C') == -1 && fieldString.indexOf('S') == -1 && fieldString.indexOf('s') == -1 && fieldString.indexOf('T') == -1) {
			return false;
		}
		return true;
	}
	...
	public boolean checkRandomSpeedRange(int min, int max, int timesToCheck) {
		...
		for (int i = 0; i < timesToCheck; i++) {
			Robot testBot = new CircleRobot(new Point(0, 0));
	...
	public void runTests() {
		...
		testContainer = new Container(new CircleRobot(new Point(0, 0), new Point(1, 1)));
		...
		testContainer = new Container(new CircleRobot(new Point(testField.getNumberOfColumns() -1, 0), new Point(1, 1)));
		System.out.println(checkBotLocation(testContainer, 0, 4, 0));

		System.out.print("BattleBot starts in bottom left corner: ");
		testField = new Console(5, 5);
		testContainer = new Container(new CircleRobot(new Point(0, testField.getNumberOfRows() - 1), new Point(1, 1)));
		System.out.println(checkBotLocation(testContainer, 0, 0, 4));

		System.out.print("BattleBot starts in bottom right corner: ");
		testField = new Console(5, 5);
		testContainer = new Container(new CircleRobot(new Point(testField.getNumberOfColumns() -1, testField.getNumberOfRows() - 1), new Point(1, 1)));
		...
		testContainer = new Container(new CircleRobot(new Point(0, 0), new Point(2, 1)));
		testContainer.moveBots(1);
		...
		testContainer = new Container(new CircleRobot(new Point(0, 0), new Point(1, 2)));
		testContainer.moveBots(1);
		...
		testContainer = new Container(new CircleRobot(new Point(0, 0)));
